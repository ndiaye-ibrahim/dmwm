...
describe('Membre routing resolve service', () => {
  ...
  let routingResolveService: MembreRoutingResolveService;
  let service: MembreService;
  let resultMembre: IMembre | undefined;
  ...
  beforeEach(() => {
    ...
    routingResolveService = TestBed.inject(MembreRoutingResolveService);
  ...
  describe('resolve', () => {
    ...
    it('should return new IMembre if id is not provided', () => {
      // GIVEN
      ...
      expect(resultMembre).toEqual(new Membre());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as Membre })));
      mockActivatedRouteSnapshot.params = { id: 123 };
