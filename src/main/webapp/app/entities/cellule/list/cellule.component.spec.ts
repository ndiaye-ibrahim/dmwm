...
describe('Cellule Management Component', () => {
  let comp: CelluleComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(CelluleComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.cellules?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
